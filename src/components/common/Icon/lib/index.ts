...
export { default as sticker_active } from './sticker_active_icon.svg';
export { default as background } from './background_icon.svg';
export { default as background_active } from './background_active_icon.svg';
export { default as background_white } from './background_white_icon.svg';
export { default as text } from './text_icon.svg';
...
export { default as invite_cancel } from './invite_cancel_icon.svg';
